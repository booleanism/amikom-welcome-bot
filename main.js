...
var chats = ['6282138157060-1620437196@g.us','6281229904389-1558389407@g.us']
...
const welcome = async (client, chat, whos) => {
    if (welcomeStatus) {
        ...
        await client.sendLinkWithAutoPreview(chat, "http://wa.me/6283164600533", `Jika ada pertanyaan bisa langsung menuju link ini http://wa.me/6283164600533
